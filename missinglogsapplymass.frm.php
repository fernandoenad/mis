...
$teacherDetails = dbquery("select * from missinglogs inner join teacher on ml_userid=teach_bio_no where ml_approve_user_no='0' order by teach_lname asc, teach_fname asc , ml_checkdate asc, ml_checktime asc limit 50");
?>
<div class="modal-content">
    <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&times;</button>
		<h4 class="modal-title">Mass Approval/Disapproval Panel</h4>
    </div>
