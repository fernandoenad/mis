...
<table border="0" cellspacing="0" cellpadding="0" width="800">
	<tr>
		...
		- <?php echo ($_GET['term']=="grade_q1"?"First Quarter/Midterms":($_GET['term']=="grade_q2"?"Second Quarter/Finals":($_GET['term']=="grade_q3"?"Third Quarter/Midterms":($_GET['term']=="grade_q4"?"Fourth Quarter/Finals":"Average"))));?> | <a href="summaryOfGrades1QRA.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $_GET['classProfile'];?>&term=<?php echo $_GET['term'];?>">Download QRA</a><br><br>
		</td>
		<td align="right">
