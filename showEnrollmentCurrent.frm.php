		...
		<div class="card-body">
				<table class="table table-condensed">
					...
					<tr>
						...
						<td width="35%">
							<a href="" onclick="window.open('classList2.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=current', '', 'width=800, height=600'); return false;"><?php echo $dataClasses['section_name'];?></a> /
							<a href="" onclick="window.open('classListBC.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=current', '', 'width=800, height=600'); return false;"><span class="glyphicon glyphicon-barcode"></span></a> /
							<a href="" onclick="window.open('classListCOMEA.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=current', '', 'width=800, height=600'); return false;"><span class="glyphicon glyphicon-list"></span></a>
						</td>
						<?php
