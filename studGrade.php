		...
		<td width="47%" align="left" valign="top">
			...
			<table border="1" cellspacing="0" cellpadding="0" width="95%">
				...
				<tr height="45">
					...
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m1']) ? $dataAtt2['sch_m1'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m2']) ? $dataAtt2['sch_m2'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m3']) ? $dataAtt2['sch_m3'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m4']) ? $dataAtt2['sch_m4'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m5']) ? $dataAtt2['sch_m5'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m6']) ? $dataAtt2['sch_m6'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m7']) ? $dataAtt2['sch_m7'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m8']) ? $dataAtt2['sch_m8'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m9']) ? $dataAtt2['sch_m9'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m10']) ? $dataAtt2['sch_m10'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m11']) ? $dataAtt2['sch_m11'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m12']) ? $dataAtt2['sch_m12'] : "");?></td>
					<?php
				...
				<tr height="45">
					...
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m1']) ? $dataAtt1['sch_m1']-$dataAtt2['sch_m1'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m2']) ? $dataAtt1['sch_m2']-$dataAtt2['sch_m2'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m3']) ? $dataAtt1['sch_m3']-$dataAtt2['sch_m3'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m4']) ? $dataAtt1['sch_m4']-$dataAtt2['sch_m4'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m5']) ? $dataAtt1['sch_m5']-$dataAtt2['sch_m5'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m6']) ? $dataAtt1['sch_m6']-$dataAtt2['sch_m6'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m7']) ? $dataAtt1['sch_m7']-$dataAtt2['sch_m7'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m8']) ? $dataAtt1['sch_m8']-$dataAtt2['sch_m8'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m9']) ? $dataAtt1['sch_m9']-$dataAtt2['sch_m9'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m10']) ? $dataAtt1['sch_m10']-$dataAtt2['sch_m10'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m11']) ? $dataAtt1['sch_m11']-$dataAtt2['sch_m11'] : "");?></td>
					<td align="center" valign="middle"><?php echo (isset($dataAtt2['sch_m12']) ? $dataAtt1['sch_m12']-$dataAtt2['sch_m12'] : "");?></td>
...
<table border="0" cellspacing="0" cellpadding="0" width="1000">
	<tr>
		<td width="47%" align="left" valign="top">
			...
			<table border="1" cellspacing="0" cellpadding="0" width="100%">	
				...
				<tr height="35">
					...
					<td align="<?php echo (substr($dataGrade['pros_desc'],0,3) == "***" ? "left": "center"); ?>"><?php echo ($dataGrade['grade_q1']<60?"":$dataGrade['grade_q1']); 
						$aveQ1 += ($dataGrade['grade_q1']*$dataGrade['pros_unit']);?></td>
					<td align="<?php echo (substr($dataGrade['pros_desc'],0,3) == "***" ? "left": "center"); ?>"><?php echo ($dataGrade['grade_q2']<60?"":$dataGrade['grade_q2']); 
						$aveQ2 += ($dataGrade['grade_q2']*$dataGrade['pros_unit']);?></td>
					<td align="<?php echo (substr($dataGrade['pros_desc'],0,3) == "***" ? "left": "center"); ?>"><?php echo ($dataGrade['grade_q3']<60?"":$dataGrade['grade_q3']); 
						$aveQ3 += ($dataGrade['grade_q3']*$dataGrade['pros_unit']);?></td>
					<td align="<?php echo (substr($dataGrade['pros_desc'],0,3) == "***" ? "left": "center"); ?>"><?php echo ($dataGrade['grade_q4']<60?"":$dataGrade['grade_q4']); 
					...
					<td align="center"><strong>
						...
						if($dataGrade['pros_level']<11 && ($dataGrade['grade_q1']<60 || $dataGrade['grade_q2']<60 || $dataGrade['grade_q3']<60 || $dataGrade['grade_q4']<60)){
							...
							if(substr($dataGrade['pros_desc'],0,3) == "***"){
							    $remarks = "";
							} else {
		...
		<td width="47%" align="left" valign="top">
			...
			$coreval_q1 = unserialize(isset($dataCoreVal['coreval_q1']) ? $dataCoreVal['coreval_q1'] : "");
			$coreval_q2 = unserialize(isset($dataCoreVal['coreval_q2']) ? $dataCoreVal['coreval_q2'] : "");
			$coreval_q3 = unserialize(isset($dataCoreVal['coreval_q3']) ? $dataCoreVal['coreval_q3'] : "");
			$coreval_q4 = unserialize(isset($dataCoreVal['coreval_q4']) ? $dataCoreVal['coreval_q4'] : "");
			$coreval_q5 = unserialize(isset($dataCoreVal['coreval_q5']) ? $dataCoreVal['coreval_q5'] : "");
			$coreval_q6 = unserialize(isset($dataCoreVal['coreval_q6']) ? $dataCoreVal['coreval_q6'] : "");
			$coreval_q7 = unserialize(isset($dataCoreVal['coreval_q7']) ? $dataCoreVal['coreval_q7'] : "");
			?>
