		...
		?>
			...
			<table border="1" cellspacing="0" cellpadding="1" width="780">
				...
				<tr height="17">
					...
					<td align="<?php echo (substr($dataGrade1['pros_desc'],0,3) == "***" ? "left" : "center");?>"><?php echo ($dataGrade1['grade_q1']==0?"-":$dataGrade1['grade_q1']); ?></td>
					<td align="<?php echo (substr($dataGrade1['pros_desc'],0,3) == "***" ? "left" : "center");?>"><?php echo ($dataGrade1['grade_q2']==0?"-":$dataGrade1['grade_q2']); ?></td>
					<td align="<?php echo (substr($dataGrade1['pros_desc'],0,3) == "***" ? "left" : "center");?>"><?php echo ($dataGrade1['grade_q3']==0?"-":$dataGrade1['grade_q3']); ?></td>
					<td align="<?php echo (substr($dataGrade1['pros_desc'],0,3) == "***" ? "left" : "center");?>"><?php echo ($dataGrade1['grade_q4']==0?"-":$dataGrade1['grade_q4']); ?></td>
					<td align="center"><?php echo ($dataGrade1['grade_final']==0 || $dataGrade1['grade_q2']==0 || $dataGrade1['grade_q3']==0 || $dataGrade1['grade_q4']==0 || substr($dataGrade1['pros_desc'],0,3) == "***"?"":$dataGrade1['grade_final'] ); ?></td>
					<td align="center"><?php echo ($dataGrade1['grade_final']==0 || $dataGrade1['grade_q2']==0 || $dataGrade1['grade_q3']==0 || $dataGrade1['grade_q4']==0 || substr($dataGrade1['pros_desc'],0,3) == "***"?"":($dataGrade1['grade_remarks']==1?"PASSED":"FAILED"));?></td>
				</tr>
				<?php 
...
<?php $panelCounter++; ?>
<?php if ($panelCounter==2) { ?>
	<table width="780" border="1" cellpadding="0" cellspacing="0">
		<tr><td>
			<table width="100%">
				<tr><td align="center"><h2>CERTIFICATION</h2></td></tr>
				<tr><td align="left">I CERTIFY that this is a true record of <strong><u><?php echo strtoupper($dataStudent['stud_fname']." ".($dataStudent['stud_mname']=="-"?"":$dataStudent['stud_mname'])." ".$dataStudent['stud_lname']." ".$dataStudent['stud_xname']);?></u></strong> with LRN <strong><u><?php echo $dataStudent['stud_lrn'];?></u></strong> and that he/she is  eligible for admission to <u><input type="text" style="width: 50px; border: 0px; font-weight: bold !important; font-size: 10px"" value="_______"></u></td></tr>
				<tr><td align="left">Name of School: <strong><u><?php echo $current_school_name;?></u></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; School ID: <strong><u><?php echo $current_school_code;?></u></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Last School Year Attended: <strong><u><input type="text" style="width: 59px; border: 0px; font-weight: bold !important; font-size: 10px"" value="________">.</u></strong></td></tr>
...
?>
		...
		<table border="0" cellspacing="1" cellpadding="0" width="780">
			<tr height="35">
				<td>
					School: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']==""?"___________________________":strtoupper($current_school_name));?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table width="780" border="1" cellpadding="0" cellspacing="0">
		<tr><td>
			<table width="100%">
				...
				<tr><td align="left">Name of School: <strong><u><?php echo $current_school_name;?></u></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; School ID: <strong><u><?php echo $current_school_code;?></u></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Last School Year Attended: <strong><u><input type="text" style="width: 59px; border: 0px; font-weight: bold !important; font-size: 10px"" value="<?php echo $dataEnroll['enrol_sy'];?>-<?php echo $dataEnroll['enrol_sy']+1;?>">.</u></strong></td></tr>
				<tr><td align="left"></td></tr>
				<tr><td align="left">
				<table width="100%">
					<tr>
