<?php
/* Data base details */
$dsn='mysql:host=localhost;dbname=u440980669_mis'; //DSN
$db_user='u440980669_mis'; //DB username 
$db_pass='Fernan1985%'; //DB password 
$driver='Custom'; //Integration driver
$db_prefix=''; //prefix used for tables in database
$uid='6360b97bc876f'; //Any random unique number
...
/* Custom driver */
$usertable='frei_users'; //specifies the name of the table in which your user information is stored.
