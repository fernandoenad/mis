...
<table border="0" cellspacing="0" cellpadding="0" width="750">
	<tr>
		...
		?>
		<h2>STUDENT LIST - <?php echo $title;?> (Barcodes)</h2>
...
<table border="0" cellspacing="0" cellpadding="1" width="100%">
	...
	<tr>
		...
		<td align="center"><img src="./barcodeapp/barcode.php?text=<?php echo $data['stud_no']; ?>" alt="testing" /><br><?php echo $data['stud_no']; ?></td>
	</tr>	
	<?php 
	$i++;
	} ?>
